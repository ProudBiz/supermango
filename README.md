...
- [superpowers](https://github.com/obra/superpowers) — brainstorming, planning, execution workflows
- [gstack](https://gstacks.org/) — headless browser QA, CEO/eng plan reviews
- [context7](https://github.com/upstash/context7#installation) — library documentation lookup
- [frontend-design](https://github.com/anthropics/claude-plugins-official) — production-grade UI generation
